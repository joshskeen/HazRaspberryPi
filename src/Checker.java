 ...
 * 
 * @author josh
 *	the actual task that checks the raspberrypi site
 *
 */
	 ...
	 public void start() {
	  ...
	  public void checkRaspberryPiIsReleased() {
      	...
      	if(hasRaspBerryPi()){
      		...
      		System.out.println("check hasRaspberryPi? YES!!, at " + sdf.format(lastCheckedDate));
      	}else{
      		labelRaspberryPiStatus.setForeground(new Color(99,99,99));
      		labelRaspberryPiStatus.setText("NOPE.");
      		System.out.println("check hasRaspberryPi? NOPE., at " + sdf.format(lastCheckedDate));
      	}
      }
}
